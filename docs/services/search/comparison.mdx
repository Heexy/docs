...
This comparison covers the homepage and search engine results page (SERP) of popular search engines and Heexy, focusing on HTML size, total page size, speed, resource size, and tracking.
...
All search engines returned the same search result: **Heexy**

| Website        | HTML Size   | Total Page Size | Speed ⚡        | Size 📦        | Tracking 👁️     |
|----------------|-------------|-----------------|----------------|----------------|------------------|
| **Heexy**      | 13.23 KB    | 22.81 KB        | 🟢🟢🟢🟢🟢       | 🟢🟢🟢🟢🟢      | ❌ None           |
...
> ⚠️ Measurements as of **July 3, 2025**
...
- Every search engine was loaded in same device with **same conditions**.
- Tested with: Firefox Desktop, from Frankfurt, DE on a 5 Mbps cable connection with 28ms of latency.
- Timer is started when the page starts loading, and **stopped when the page is fully loaded.**
